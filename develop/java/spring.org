...
*** Spring 的注解方式的事务实现机制
    ...
    3. 避免 Spring 的 AOP 的自调用问题在 Spring 的 AOP 代理下，只有目
       ...
       法的事务被忽略，不会发生回滚。
*** Spring @Transactional注解中的隔离级别与DB默认的隔离级别有何不同？
    @Transactional注解中设置的隔离级别会覆盖DB默认的隔离级别。

*** 参考
    - https://www.ibm.com/developerworks/cn/java/j-master-spring-transactional-use/index.html
    - https://my.oschina.net/gaoguofan/blog/891170
    - https://www.jianshu.com/p/83a634d589e5
...
** Spring Whitelabel Error Page
   ...
   - ExceptionHandler, 方法注解, 作用于 Controller 级别.
     ExceptionHandler 注解为一个 Controler 定义一个异常处理器.
   - ControllerAdvice, 类注解, 作用于 整个 Spring 工程.
     ControllerAdvice 注解定义了一个全局的异常处理器.

*** 参考
    - * https://www.baeldung.com/spring-boot-custom-error-page
    - http://www.springboottutorial.com/spring-boot-exception-handling-for-rest-services
    - https://my.oschina.net/langwanghuangshifu/blog/2246894
    - https://blog.csdn.net/UpdateAllTheTime/article/details/82664103
    - http://blog.springcloud.cn/sc/wk2/
    - https://segmentfault.com/a/1190000006749441
    - https://my.oschina.net/exit/blog/852578
    - https://my.oschina.net/u/3049656/blog/1798583
    - https://blog.csdn.net/jianggujin/article/details/79217845
...
*** 参考
    ...
    - https://code.i-harness.com/en/q/1a1d015
    - https://www.reddit.com/r/Angular2/comments/8pfa3h/serving_angular_6_with_spring_boot/
